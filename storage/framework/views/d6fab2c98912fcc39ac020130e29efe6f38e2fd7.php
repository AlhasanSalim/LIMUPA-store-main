                   ...
                   <!-- Product Details Left -->
                    <div class="product-details-left">
                        <div class="product-details-images slider-navigation-1">
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="<?php echo e(asset('images/product/large-size/1.jpg')); ?>" data-gall="myGallery">
                    ...
                    <div class="product-details-view-content pt-60">
                        <div class="product-info">
                            ...
                            <div class="price-box pt-20">
                                <p><del class="old-price" style="font-size: 22px"><?php echo e(Currency::format($product->compare_price)  ?? null); ?></del></p>
            ...
            <div class="tab-content">
                ...
                <div id="product-details" class="tab-pane" role="tabpanel">
                    <div class="product-details-manufacturer">
                        <a href="#">
                            <img src="<?php echo e(asset('images/product-details/1.jpg')); ?>" alt="Product Manufacturer Image">
                        </a>
                                            ...
                                            <div class="modal-inner-area row">
                                                <div class="col-lg-6">
                                                   <div class="li-review-product">
                                                       <img src="<?php echo e(asset('images/product/large-size/3.jpg')); ?>" alt="Li's Product">
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            <a href="<?php echo e(route('other_prodcut.show', $product)); ?>">
                                                <img src="<?php echo e($product->image_url ?? null); ?>" alt="Li's Product Image">
                                            </a>
                                            ...
                                            <div class="product_desc_info">
                                                <div class="product-review">
                                                    <h5 class="manufacturer">
                                                        <a href="product-details.html"><?php echo e($product->category->name ?? null); ?></a>
                                                    </h5>
                                                ...
                                                <h4><a class="product_name" href="<?php echo e(route('other_prodcut.show', $product)); ?>"><?php echo e($product->name ?? null); ?></a></h4>
                                                <div class="price-box">
                                                    <span class="new-price new-price-2"><?php echo e(Currency::format($product->price)); ?></span>
                                                    <span class="old-price"><?php echo e(Currency::format($product->compare_price)); ?></span>
                                                    <span class="discount-percentage">-<?php echo e($product->sale_percent ?? null); ?>%</span>
                                                </div>
                                            </div>
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\Laravel\adminLTE_backEnd\resources\views/front/products/show.blade.php ENDPATH**/ ?>