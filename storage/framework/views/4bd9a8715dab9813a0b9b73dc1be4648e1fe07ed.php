                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="header-top-left">
                                    <ul class="phone-wrap">
                                        <li><span>Telephone Enquiry:</span><a href="#">(+20) 1116554246</a></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="header-top-right">
                                    <ul class="ht-menu">
                                        ...
                                        <li>
                                            ...
                                            <div class="ht-setting-trigger"><span style="font-size:17px"><?php echo e(Auth::user()->name); ?></span></div>
                                        ...
                                        <li>
                                            ...
                                            <div class="ht-currency-trigger"><span>EUR €</span></div>
                                        ...
                                        <li>
                                            ...
                                            <div class="language ht-language">
                                                <ul class="ht-setting-list">
                                                    <li class="active"><a href="#"><img src="<?php echo e(asset('images/menu/flag-icon/1.jpg')); ?>" alt="">English</a></li>
                                                    <li><a href="#"><img src="<?php echo e(asset('images/menu/flag-icon/2.jpg')); ?>" alt="">Français</a></li>
                                                </ul>
                                            </div>
                                        </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="index.html">
                                        <img src="<?php echo e(asset('images/menu/logo/1.jpg')); ?>" alt="">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9 pl-0 ml-sm-15 ml-xs-15">
                                ...
                                <div class="header-middle-right">
                                    <ul class="hm-menu">
                                        ...
                                        <?php if (isset($component)) { $__componentOriginal102bbc5570cfc00f39abca29c471e9886b9b2133 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\CartMenu::class, []); ?>
...
<?php endif; ?>
<?php if (isset($__componentOriginal102bbc5570cfc00f39abca29c471e9886b9b2133)): ?>
<?php $component = $__componentOriginal102bbc5570cfc00f39abca29c471e9886b9b2133; ?>
<?php unset($__componentOriginal102bbc5570cfc00f39abca29c471e9886b9b2133); ?>
<?php endif; ?>
                                        ...
                                        <ul>
                                            ...
                                            <li class="catmenu-dropdown megamenu-holder"><a href="shop-left-sidebar.html">Shop</a>
                                                <ul class="megamenu hb-megamenu">
                                                    ...
                                                    <li><a href="<?php echo e(asset('single-product.html')); ?>">Single Products</a>
                                                        <ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <ul class="des">
                                        <li>
                                            <span>Address: </span>
                                            Damietta Governorate, New Damietta, EGYPT
                                        </li>
                                        <li>
                                            <span>Phone: </span>
                                            <a href="#">(+20) 1116554246</a>
                                        </li>
                                        <li>
                                            <span>Email: </span>
                                            <a href="http://alhasan1997@hotmail.com">alhasan1997@hotmail.com</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright text-center">
                                    <a href="#">
                                        <img src="<?php echo e(asset('images/payment/1.png')); ?>" alt="">
                                    </a>
                                </div>
...
<?php /**PATH E:\xampp\htdocs\Laravel\adminLTE_backEnd - Copy\resources\views/layouts/front.blade.php ENDPATH**/ ?>